...
class MoreRegisterWide extends StatefulWidget {
  ...
  const MoreRegisterWide({super.key, required this.onDismissed});

  @override
  State<MoreRegisterWide> createState() => _MoreRegisterWideState();
}

class _MoreRegisterWideState extends State<MoreRegisterWide> {
