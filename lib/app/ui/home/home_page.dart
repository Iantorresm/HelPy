      ...
      const data = [
        {
          ...
          "apellido": "Toledo",
          "descripcion":
              "Mario Toledo es un prestador de servicios de reparacion de coches y neumaticos. Este es su perfil.",
          "direccion": "Calle 123",
          "telefono": "123456789",
          "servicios": [
            {
        ...
        },
        {
          ...
          "direccion": "Calle 123",
          "descripcion":
              "Propietario de una gomería con años de experiencia especializado en brindar soluciones rápidas y de calidad, priorizando la seguridad y satisfacción de sus clientes",
          "telefono": "123456789",
          "servicios": [
            {
              "nombre": "Cambio de neumatico",
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                    margin:
                        EdgeInsets.symmetric(vertical: 8), // Espaciado externo
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        SizedBox(
                            width:
                                16), // Espaciado entre imagen y contenido principal
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                maxLines:
                                    3, // Limita la cantidad de líneas visibles
                        ...
                        SizedBox(
                            width:
                                16), // Espaciado entre contenido principal y servicios
